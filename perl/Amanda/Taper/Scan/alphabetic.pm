...
package Amanda::Taper::Scan::alphabetic;

=head1 NAME

Amanda::Taper::Scan::alphabetic

=head1 SYNOPSIS

This package implements the "alphabetic" taperscan algorithm.  See
...
sub analyze {
	...
	if (!defined $sl->{'state'} ||
		...
		push @reusable, $sl;
	    } elsif ($sl->{'label'} !~ /$self->{'chg'}->{'labelstr'}/) {
