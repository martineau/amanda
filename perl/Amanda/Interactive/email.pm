...
package Amanda::Interactive::email;
...
Amanda::Interactive::email -- Interactive class to send user request by email

=head1 SYNOPSIS

Amanda::Interactive class to write user request by email
